package tr.wolflame.framework.base.swipe;
...
public class FlingCardListener implements View.OnTouchListener {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                try {
                    ...
                    LogApp.d(TAG, "Exception in onTouch(view, event) : " + mActivePointerId + e.toString());
                }
                if (success) {
    ...
    private static final long SELECT_EXIT_DURATION = 500;
    ...
    public void selectLeft() {
        if (!isAnimationRunning)
            onSelected(true, objectY, SELECT_EXIT_DURATION);
    }
    ...
    public void selectRight() {
        if (!isAnimationRunning)
            onSelected(false, objectY, SELECT_EXIT_DURATION);
    }
